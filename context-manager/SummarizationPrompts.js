 ...
 * Handles generation of prompts for conversation summarization
 */

export class SummarizationPrompts {
  /**
   * Generate the main summarization prompt
   * @param {string} customInstructions - Optional custom instructions
   * @returns {string} The complete summarization prompt
   */
  static getSummarizationPrompt(customInstructions = "") {
...
${customInstructions}`;
  ...
  /**
   * Format the summary response for display to the user
   * @param {string} summaryText - Raw summary from AI
   * @returns {string} Formatted summary
   */
  static formatCompactSummaryForUser(summaryText) {
  ...
  /**
   * Generate the continuation system prompt that includes the summary
   * @param {string} summaryText - The formatted summary
   * @param {boolean} shouldContinue - Whether to instruct continuation
   * @returns {string} System prompt for the new conversation
   */
  static getCompactContinuationSystemPrompt(
    summaryText,
    shouldContinue = false
  ) {
    const formattedSummary = this.formatCompactSummaryForUser(summaryText);
